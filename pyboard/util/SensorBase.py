...
class SensorBase(object):
    ...
    def sample_fsr(self):
        fsr1 = self._get_fsr_val_(self.FSR_ADC_PIN_1)
        fsr2 = self._get_fsr_val_(self.FSR_ADC_PIN_2)
        fsr3 = self._get_fsr_val_(self.FSR_ADC_PIN_3)
